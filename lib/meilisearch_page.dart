...
final _searchProvider = FutureProvider<SearchResult>((ref) async {
...
class _SearchCountText extends ConsumerWidget {
  const _SearchCountText();

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final theme = Theme.of(context);
    final count = ref.watch(_searchCountProvider).value;
    return Text(
      '検索ヒット数: ${count ?? '---'}件',
